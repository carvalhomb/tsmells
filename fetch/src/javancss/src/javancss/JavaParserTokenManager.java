...
public class JavaParserTokenManager implements JavaParserConstants
{
    ...
    static int  _iSingleComments = 0;
    static int  _iMultiComments = 0;
    static int  _iFormalComments = 0;

    static int  _iMultiCommentsLast = 0;
private final int jjStopStringLiteralDfa_0(int pos, long active0, long active1)
{
   switch (pos)
   {
      case 0:
         ...
         if ((active1 & 0x1000000000200000L) != 0L)
            return 4;
         return -1;
      case 1:
...
public JavaParserTokenManager(ASCII_UCodeESC_CharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
