...
class DuplicatedCodes(object):
	...
	def generateEdges(self):
		...
		for duplicate in self.duplicates:
			edges.append(Edge("DuplicatedCode" + str(counter), filterComma(duplicate[1])))
			if duplicate[1] != duplicate[5]:
				edges.append(Edge("DuplicatedCode" + str(counter), filterComma(duplicate[5])))
			counter += 1
		return edges
