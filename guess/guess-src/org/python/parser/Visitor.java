...
public class Visitor {
    ...
    public Object rightdiredge(SimpleNode n) throws Exception {
        throw new ParseException("Unhandled Node: "+n);
    }
    
    public Object leftdiredge(SimpleNode n) throws Exception {
        throw new ParseException("Unhandled Node: "+n);
    }

    public Object questionm(SimpleNode n) throws Exception {
        throw new ParseException("Unhandled Node: "+n);
    }

    public Object bidiredge(SimpleNode n) throws Exception {
        throw new ParseException("Unhandled Node: "+n);
    }

    public Object like(SimpleNode n) throws Exception {
	throw new ParseException("Unhandled Node: "+n);
    }

    public Object roverlaps(SimpleNode n) throws Exception {
	throw new ParseException("Unhandled Node: "+n);
    }

    public Object rcontains(SimpleNode n) throws Exception {
	throw new ParseException("Unhandled Node: "+n);
    }

    public Object rcontained(SimpleNode n) throws Exception {
	throw new ParseException("Unhandled Node: "+n);
    }

    public Object rexact(SimpleNode n) throws Exception {
	throw new ParseException("Unhandled Node: "+n);
    }
