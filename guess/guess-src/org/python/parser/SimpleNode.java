...
public class SimpleNode implements Node
{
    ...
    public Object visit(Visitor visitor) throws Exception {
        ...
        case PythonGrammarTreeConstants.JJTLEFTDIREDGE:
            return visitor.leftdiredge(this);
        case PythonGrammarTreeConstants.JJTQUESTIONM:
            return visitor.questionm(this);
        case PythonGrammarTreeConstants.JJTRIGHTDIREDGE:
            return visitor.rightdiredge(this);
        case PythonGrammarTreeConstants.JJTBIDIREDGE:
            return visitor.bidiredge(this);
	case PythonGrammarTreeConstants.JJTLIKE:
	    return visitor.like(this);
	case PythonGrammarTreeConstants.JJTRCONTAINS:
	    return visitor.rcontains(this);
	case PythonGrammarTreeConstants.JJTREXACT:
	    return visitor.rexact(this);
	case PythonGrammarTreeConstants.JJTRCONTAINED:
	    return visitor.rcontained(this);
	case PythonGrammarTreeConstants.JJTROVERLAPS:
