...
public class PyObject implements java.io.Serializable {
    ...
    **/
     ...
     * @return the result of the comparison.
     **/
    public PyObject __lde__(PyObject other) { return null; }
     ...
     * @return the result of the comparison.
     **/
    public PyObject __anye__(PyObject other) { return null; }
     ...
     * @return the result of the comparison.
     **/
    public PyObject __rde__(PyObject other) { return null; }
     ...
     * @return the result of the comparison.
     **/
    public PyObject __bde__(PyObject other) { return null; }
     ...
     * @return the result of the comparison.
     **/
    public PyObject __like__(PyObject other) { return null; }
     ...
     * @return the result of the comparison.
     **/
    public PyObject __rcontains__(PyObject other) { return null; }
     ...
     * @return the result of the comparison.
     **/
    public PyObject __rexact__(PyObject other) { return null; }
     ...
     * @return the result of the comparison.
     **/
    public PyObject __rcontained__(PyObject other) { return null; }
     ...
     * @return the result of the comparison.
     **/
    public PyObject __roverlaps__(PyObject other) { return null; }
    ...
    /**
     * Implements the Python expression <code>this like other</code>.
     *
     * @param other the object to compare this with.
     * @return the result of the comparison
     **/
    public final PyObject _like(PyObject o) {
        ...
        ThreadState ts = Py.getThreadState();
        try {
	    //System.out.println("woohoo like");
            if (++ts.compareStateNesting > 10) {
                if ((token = check_recursion(ts, this, o)) == null)
                    return Py.Zero;
            }
            PyObject res = __like__(o);
            if (res != null)
                return res;
            res = o.__like__(this);
            if (res != null)
    ...
    /**
     * Implements the Python expression <code>this roverlaps other</code>.
     *
     * @param other the object to compare this with.
     * @return the result of the comparison
     **/
    public final PyObject _roverlaps(PyObject o) {
        ...
        ThreadState ts = Py.getThreadState();
        try {
	    //System.out.println("woohoo roverlaps");
            if (++ts.compareStateNesting > 10) {
                if ((token = check_recursion(ts, this, o)) == null)
                    return Py.Zero;
            }
            PyObject res = __roverlaps__(o);
            if (res != null)
                return res;
            res = o.__roverlaps__(this);
            if (res != null)
                return res;
            return Py.Zero;
        } finally {
    ...
    /**
     * Implements the Python expression <code>this rcontained other</code>.
     *
     * @param other the object to compare this with.
     * @return the result of the comparison
     **/
    public final PyObject _rcontained(PyObject o) {
        ...
        ThreadState ts = Py.getThreadState();
        try {
	    //System.out.println("woohoo rcontained");
            if (++ts.compareStateNesting > 10) {
                if ((token = check_recursion(ts, this, o)) == null)
                    return Py.Zero;
            }
            PyObject res = __rcontained__(o);
            if (res != null)
                return res;
            res = o.__rcontained__(this);
            if (res != null)
                return res;
            return Py.Zero;
        } finally {
    ...
    /**
     * Implements the Python expression <code>this rcontains other</code>.
     *
     * @param other the object to compare this with.
     * @return the result of the comparison
     **/
    public final PyObject _rcontains(PyObject o) {
        ...
        ThreadState ts = Py.getThreadState();
        try {
	    //System.out.println("woohoo rcontains");
            if (++ts.compareStateNesting > 10) {
                if ((token = check_recursion(ts, this, o)) == null)
                    return Py.Zero;
            }
            PyObject res = __rcontains__(o);
            if (res != null)
                return res;
            res = o.__rcontains__(this);
            if (res != null)
                return res;
            return Py.Zero;
        } finally {
    ...
    /**
     * Implements the Python expression <code>this rexact other</code>.
     *
     * @param other the object to compare this with.
     * @return the result of the comparison
     **/
    public final PyObject _rexact(PyObject o) {
        ...
        ThreadState ts = Py.getThreadState();
        try {
	    //System.out.println("woohoo rexact");
            if (++ts.compareStateNesting > 10) {
                if ((token = check_recursion(ts, this, o)) == null)
                    return Py.Zero;
            }
            PyObject res = __rexact__(o);
            if (res != null)
                return res;
            res = o.__rexact__(this);
            if (res != null)
                return res;
            return Py.Zero;
        } finally {
