...
public class PyInstance extends PyObject
{
    ...
    protected boolean edgeType = false;

    protected boolean typeOfInterest = false;
    ...
    **/
    ...
    public boolean isEdgeProxy() {
	return(edgeType);
    }

    public boolean isGraphElementProxy() {
	return(nodeType || edgeType);
    }
    ...
    **/
	...
	return ifindfunction(name); // commented out by eytan

	// start added by eytan
	/*PyObject func = ifindfunction(name);
	if (func != null) {
	    return(func);
	}

	// invoke the __getattr__ on the object directly
	// if possible -> lets us override set/get ops
        return invoke("__getattr__",new PyString(name)); 
	// end added by eytan
	*/
    }
    ...
    public void __setattr__(String name, PyObject value) {
        ...
        if (setter != null) {
		    ...
		    // added by eytan
		    // invoke the __setattr__ on the object directly
		    // if possible -> lets us override set/get ops
		    /*PyObject t = 
			invoke_ex("__setattr__",new PyString(name),value);
		    if (t == null)*/ // end added by eytan 
			noField(name, value);
    ...
    public PyObject __lde__(PyObject o) {
        return invoke_ex_richcmp("__lde__", o);
    }

    public PyObject __anye__(PyObject o) {
        return invoke_ex_richcmp("__anye__", o);
    }

    public PyObject __rde__(PyObject o) {
        return invoke_ex_richcmp("__rde__", o);
    }

    public PyObject __bde__(PyObject o) {
        return invoke_ex_richcmp("__bde__", o);
    }

    public PyObject __like__(PyObject o) {
        return invoke_ex_richcmp("__like__", o);
    }

    public PyObject __rcontains__(PyObject o) {
        return invoke_ex_richcmp("__rcontains__", o);
    }

    public PyObject __rcontained__(PyObject o) {
        return invoke_ex_richcmp("__rcontained__", o);
    }

    public PyObject __rexact__(PyObject o) {
        return invoke_ex_richcmp("__rexact__", o);
    }

    public PyObject __roverlaps__(PyObject o) {
        return invoke_ex_richcmp("__roverlaps__", o);
    }
