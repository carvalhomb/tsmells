...
public abstract class CachedJarsPackageManager extends PackageManager {
    ...
    public void loadResource(URL pkc, String jarfile) {
	Hashtable zipPackages = loadResource(pkc);
	addPackages(zipPackages,jarfile);
    }

    private Hashtable loadResource(URL pkc)
    {
        try {
            DataInputStream istream = 
		new DataInputStream(new BufferedInputStream(pkc.openStream()));
	...
	//System.out.println(jarcanon + " " + cachefile);
