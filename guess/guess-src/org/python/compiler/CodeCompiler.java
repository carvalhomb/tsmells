    ...
    implements CompilationContext, ClassConstants, PythonGrammarTreeConstants
{
    ...
    public Object rightdiredge(SimpleNode node) throws Exception {
        if (mrefs.rightdiredge == null) rightdiredge = new Integer(make_binop("_rde"));
        return mrefs.rightdiredge;
    }

    public Integer leftdiredge;
    public Object leftdiredge(SimpleNode node) throws Exception {
        if (mrefs.leftdiredge == null) leftdiredge = new Integer(make_binop("_lde"));
        return mrefs.leftdiredge;
    }

    public Integer questionm;
    public Object questionm(SimpleNode node) throws Exception {
        if (mrefs.questionm == null) questionm = new Integer(make_binop("_anye"));
        return mrefs.questionm;
    }

    public Integer bidiredge;
    public Object bidiredge(SimpleNode node) throws Exception {
        if (mrefs.bidiredge == null) bidiredge = new Integer(make_binop("_bde"));
        return mrefs.bidiredge;
    }

    public Integer like;
    public Object like(SimpleNode node) throws Exception {
	if (mrefs.like == null) like = new Integer(make_binop("_like"));
	return mrefs.like;
    }

    public Integer rexact;
    public Object rexact(SimpleNode node) throws Exception {
	if (mrefs.rexact == null) rexact = new Integer(make_binop("_rexact"));
	return mrefs.rexact;
    }

    public Integer rcontained;
    public Object rcontained(SimpleNode node) throws Exception {
	if (mrefs.rcontained == null) rcontained = new Integer(make_binop("_rcontained"));
	return mrefs.rcontained;
    }

    public Integer rcontains;
    public Object rcontains(SimpleNode node) throws Exception {
	if (mrefs.rcontains == null) rcontains = new Integer(make_binop("_rcontains"));
	return mrefs.rcontains;
    }

    public Integer roverlaps;
    public Object roverlaps(SimpleNode node) throws Exception {
	if (mrefs.roverlaps == null) roverlaps = new Integer(make_binop("_roverlaps"));
	return mrefs.roverlaps;
    }
