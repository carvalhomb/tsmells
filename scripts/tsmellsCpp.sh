...
MACRO="-DXUNIT_INIT=$TSMELLS/src/initCppUnitv1.12.rml -DASSERTIONLESS -DDUPLICATED_CODE -DINDIRECT_TEST -DINDENTED_TEST -DMYSTERY_GUEST -DASSERTION_ROULETTE -DSENSITIVE_EQUALITY -DFOR_TESTERS_ONLY -DINDIRECT_TEST_TRESHOLD=4 -DDUPLICATED_CODE_PYGEN=$TSMELLS/src/DuplicatedCode.py -DDUPLICATED_CODE_TRESHOLD=8 -DMYSTERY_GUEST_BLACKLIST=$TSMELLS/src/MysteryBlacklistCppFile.rml"
RSF=$PROJ.rsf
