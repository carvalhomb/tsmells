...
ifdef(`DUMP_TEST_ENTITIES', `include(DUMP_DIR`computeTestEntities.rml')', `')
...
ifdef(`EAGER_TEST_PTMI_TRESHOLD', `', `define(`EAGER_TEST_PTMI_TRESHOLD', `5')')
ifdef(`EAGER_TEST', `include(DUMP_DIR`computeEagerTest.rml')', `')
ifdef(`FOR_TESTERS_ONLY', `include(DUMP_DIR`computeForTestersOnly.rml')', `')
ifdef(`GENERAL_FIXTURE_NFOB_TRESHOLD', `', `define(`GENERAL_FIXTURE_NFOB_TRESHOLD', `5')')
ifdef(`GENERAL_FIXTURE_NFPT_TRESHOLD', `', `define(`GENERAL_FIXTURE_NFPT_TRESHOLD', `5')')
ifdef(`GENERAL_FIXTURE_NOBU_TRESHOLD', `', `define(`GENERAL_FIXTURE_NOBU_TRESHOLD', `5')')
...
ifdef(`VERBOSE_TEST_LOC_TRESHOLD', `', `define(`VERBOSE_TEST_LOC_TRESHOLD', `20')')
ifdef(`VERBOSE_TEST', `include(DUMP_DIR`computeVerboseTest.rml')', `')
