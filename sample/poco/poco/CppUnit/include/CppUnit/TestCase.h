...
void loop_1_assert(const int datalline, bool condition);
void loop_2_assert(const int data1line, const int data2line,bool condition);
template < typename A, typename B, typename C > void assertEqualDelta(A expected, B actual, C delta);
template < typename A, typename B > void assertEqual(A expected, B actual);
template < typename A > void assertNullPtr(A ptr);
template < typename A > void assertNotNullPtr(A ptr);
template < typename A > void failmsg(A msg);
