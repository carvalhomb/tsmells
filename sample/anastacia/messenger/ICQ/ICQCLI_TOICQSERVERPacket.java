 ...
 */
public class ICQCLI_TOICQSERVERPacket extends ICQOutgoingPacket {
	
	/**
	 * Method ICQCLI_TOICQSERVERPacket.
	 * @param Vector arg
	 * @pre assert arg.size() == 0
	 */
	public ICQCLI_TOICQSERVERPacket(Vector arg) {
		assert (arg.size() == 0);
		
		setKindOfPacket("CLI_TOICQSERVER");
		updatePacket();
	}
