...
/**
 * A class for an incoming initial online notification packet
 * 
 * @author Benny Van Aerschot
 * @version  $Revision: 1.1 $
 * @date $Date: 2003/04/04 18:03:25 $
 */
public class MSNIncomingILNPacket extends MSNIncomingPacket {
	 ...
	 */
	public MSNIncomingILNPacket(String receivedPacket) {
		super(receivedPacket);
		
		fStatus = (String)tokens.elementAt(2);
		fContact = (String)tokens.elementAt(3);
		fContactNick = (String)tokens.elementAt(4);
	}
