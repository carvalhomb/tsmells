...
/**
 * A class for an incoming offline notification packet
 * 
 * @author Benny Van Aerschot
 * @version  $Revision: 1.2 $
 * @date $Date: 2003/05/04 19:37:21 $
 */
public class MSNIncomingFLNPacket extends MSNIncomingPacket {
	private String fContact = null;

	/**
	 * @see messenger.MSN.MSNIncomingPacket#MSNIncomingPacket(String)
	 */
	public MSNIncomingFLNPacket(String receivedPacket) {
