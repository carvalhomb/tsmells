 ...
 * @date $Date: 2003/04/16 17:00:42 $
 * 
 * This command requests from the server certain information about the client that is stored on the server.
 */
public class ICQCLI_REQINFOPacket extends ICQOutgoingPacket {
	
	
	/**
	 * Method ICQCLI_REQINFOPacket.
	 * @param Vector arg
	 * 
	 * @pre assert arg.size() == 0
	 */
	public ICQCLI_REQINFOPacket(Vector arg) {
		assert (arg.size() == 0);
		
		setKindOfPacket("CLI_REQINFO");
		updatePacket();
	}
