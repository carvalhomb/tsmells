 ...
 */
public class ICQCLI_REQBUDDYPacket extends ICQOutgoingPacket {
	/**
	 * Method ICQCLI_REQBUDDYPacket.
	 * @param Vector arg
	 * @pre assert arg.size() == 0
	 */
	public ICQCLI_REQBUDDYPacket(Vector arg) {
		assert (arg.size() == 0);
		
		setKindOfPacket("CLI_REQBUDDY");
		updatePacket();
	}
