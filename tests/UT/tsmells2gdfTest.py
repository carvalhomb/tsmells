...
class TestCasesTest(RootTest):
    ...
    def testGenerateNodesMulti(self):
        ...
        expNode2 = Node("BarTest", "black", \
                        "testcase", "BarTest", 1, isSrcEnt=1)
        expNode3 = Node("BazTest", "black", \
                        "testcase","BazTest", 1, isSrcEnt=1)
        self.assertTrue(expNode2 in nodes)
...
class TestCommandsTest(RootTest):
    def setUp(self):
        ...
        self.toParse = ["TestCommand", self.key, "FooTest.java", "10", "FooTest", "4"]
        self.expNode = Node(name=self.key, color="black", label="testFoo()", \
                            entity="testcommand", style=2, isSrcEnt=1)
    ...
    def testParseMulti(self):
        ...
        toParse2 = ["TestCommand", "BazTest.tesBaz()", "BazTest.java", "15", "BazTest", "8"]
        key2 = "BazTest.tesBaz()"
...
class TestHelpersTest(RootTest):
    ...
    def testParse(self):
        toParse = ["TestHelper", "FooTest.helper()", "FooTest.java", "15", "FooTest", "4"]
        key = "FooTest.helper()"
    ...
    def testParseParams(self):
        toParse = ["TestHelper", "FooTest.construct(String,Integer)", "FooTest.java", "15", "FooTest", "11"]
...
class TestSetupsTest(RootTest):
    ...
    def testParse(self):
        toParse = ["TestSetup", "FooTest.setUp()", "FooTest.java", "15", "FooTest", "15"]
        key = "FooTest.setUp()"
        location = ("FooTest.java", 15)
...
class TestTeardownsTest(RootTest):
    ...
    def testParse(self):
        toParse = ["TestTeardown", "FooTest.tearDown()", "FooTest.java", "15", "FooTest", "12"]
...
class DuplicatedCodesTest(TestCase):
    def setUp(self):
        ...
        self.dupLoc1 = ("BtPieceMessageTest.cc", 197, 206)
        self.dupLoc2 = ("BtPieceMessageTest.cc", 183, 193)
        ...
        self.dupLoc21 = ("Faz.cpp", 20, 25)
        self.dupLoc22 = ("Boo.cpp", 30, 35)
    ...
    def testAppendLocationInfoQuad(self):
        ...
        self.dupLoc3 = ("FooTest.cpp", 20, 25)
        self.mtd4 = "BazTest.testBaz()"
        self.dupLoc4 = ("BazTest.cpp", 30, 35)
